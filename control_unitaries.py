...
def C_2mod15(Quantum_program_object,Circuit_name,Quantum_register_name,Control_bit_number):
	...
	qc.cswap(qr[Control_bit_number],qr[3],qr[2])
	...
	qc.cswap(qr[Control_bit_number],qr[2],qr[1])
	...
	qc.cswap(qr[Control_bit_number],qr[1],qr[0])
...
def C_11mod15(Quantum_program_object,Circuit_name,Quantum_register_name,Control_bit_number):
	...
	qc.cswap(qr[Control_bit_number],qr[2],qr[0])
	...
	qc.cswap(qr[Control_bit_number],qr[3],qr[1])
